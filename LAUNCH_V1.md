...
- Latest 30 brew visibility limit for Free users
- Full Brew History for Pro users
- Final decision and implementation for Pro-only back bag photo access
- Final decision and implementation for Pro-only brew photo access
- Upgrade screen
- Pricing page
- Paystack checkout
...
- [ ] Apply final Free/Pro image-access rules if back bag photo remains a Pro feature
...
- [ ] Apply final Free/Pro brew-photo rule if brew photos remain a Pro feature

## Brew History Monetisation

- [ ] Free users can continue logging indefinitely
- [ ] Free users see only their latest 30 brew records
- [ ] No brew records are deleted when the Free visibility limit is reached
- [ ] Search and filters for Free users cannot expose records outside the visible 30
- [ ] Pro users can access full Brew History
- [ ] Full user-data export remains available to Free users
- [ ] Free -> Pro history unlock test
- [ ] Pro -> Free history restriction test
...
- [ ] Final Free/Pro feature matrix verification
...
- [ ] Implement Free 30-brew History visibility rule
- [ ] Verify History search cannot bypass the Free limit
- [ ] Finalise Pro gating decision for back bag photo
- [ ] Finalise Pro gating decision for brew photos
...
- [ ] Implement Free 30-brew History visibility limit
- [ ] Test full History access for Pro
- [ ] Confirm final photo feature rules
...
| Back bag photo | TBD | Yes | Final rule pending |
| Log brews indefinitely | Yes | Yes | Complete |
| Brew Again | Yes | Yes | Complete |
| Brew History | Latest 30 | Full | Pending |
| Search/filter History | Visible 30 only | Full | Pending |
...
| Brew photo | TBD | Yes | Final rule pending |
...
- Create a clear reason to upgrade through historical access and deeper analysis.
...
- [ ] Free Brew History limit is complete
- [ ] Final Free/Pro photo rules are complete
...
1. Implement the Free latest-30 Brew History visibility rule.
2. Verify Free search and filters cannot expose older records.
3. Verify upgrading to Pro immediately restores full History.
4. Decide and implement the final back bag photo and brew photo Free/Pro rules.
5. Build the Paystack server-side integration.
6. Build checkout and webhook handling.
7. Connect payment status to `billing_subscriptions` and `user_entitlements`.
8. Build the Upgrade and Pricing screens.
9. Build subscription management, cancellation and failed-payment handling.
